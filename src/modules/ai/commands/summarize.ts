  ...
  async execute(interaction: ChatInputCommandInteraction): Promise<void> {
    ...
    try {
      ...
      const content = [
        ...
        text,
        `-# Generated by **${name}** (${source}). AI can make mistakes. Usernames anonymized.${(() => { const l = remaining(interaction.user.id, getAIConfig(interaction.user.id).model); return l !== null ? ` \u2022 ${l} req left` : ''; })()} \u2022 [Learn more](${LEARN_MORE})`,
      ].join('\n');
