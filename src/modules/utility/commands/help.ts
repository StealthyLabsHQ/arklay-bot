...
const CATEGORIES: Record<string, Category> = {
  ...
  moderation: {
    ...
    commands: [
      ...
      { name: 'modlogs',     desc: { en: 'View moderation history for a user', fr: 'Historique de mod\u00e9ration d\'un utilisateur' }, usage: '/modlogs <user>', admin: true },
      { name: 'case',        desc: { en: 'View a specific moderation case by ID', fr: 'Voir un cas de mod\u00e9ration par ID' }, usage: '/case <id>', admin: true },
      { name: 'antinuke',    desc: { en: 'Configure anti-nuke protection', fr: 'Configurer la protection anti-nuke' }, usage: '/antinuke <enable|config|whitelist|status|logs>', admin: true },
    ],
  },
  utility: {
    ...
    commands: [
      ...
      { name: 'userinfo',    desc: { en: 'User info, permissions, join position', fr: 'Infos, permissions, position d\'arriv\u00e9e' }, usage: '/userinfo <info|permissions|joinposition> [user]' },
      { name: 'serverinfo',  desc: { en: 'Server stats or icon/banner', fr: 'Stats du serveur ou icone/banni\u00e8re' }, usage: '/serverinfo <info|icon>' },
      ...
      { name: 'channelinfo', desc: { en: 'Channel info or first message', fr: 'Infos sur un salon ou premier message' }, usage: '/channelinfo <info|firstmessage> [channel]' },
      ...
      { name: 'tags',       desc: { en: 'Custom server text snippets', fr: 'Raccourcis texte personnalis\u00e9s' }, usage: '/tags <create|show|list|edit|delete>', admin: true },
      { name: 'giveaway',   desc: { en: 'Create and manage giveaways', fr: 'Cr\u00e9er et g\u00e9rer des cadeaux' }, usage: '/giveaway <start|end|reroll>', admin: true },
      { name: 'twitch',     desc: { en: 'Check if a Twitch streamer is live', fr: 'V\u00e9rifier si un streamer est en live' }, usage: '/twitch <username>' },
      { name: 'audit',      desc: { en: 'View recent audit log entries', fr: 'Voir les entr\u00e9es r\u00e9centes du journal d\'audit' }, usage: '/audit [limit]', admin: true },
    ],
  },
  fun: {
    ...
    commands: [
      ...
      { name: 'leaderboard', desc: { en: 'Top music listeners on this server', fr: 'Top auditeurs du serveur' }, usage: '/leaderboard [period]' },
    ],
  },
  configuration: {
